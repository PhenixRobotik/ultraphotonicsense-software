...
void gpio_setup() {
  ...
  gpio_mode_setup(GPIO_US_ECHO_0_PORT, GPIO_MODE_INPUT, GPIO_PUPD_NONE, GPIO_US_ECHO_0_PIN);
  gpio_mode_setup(GPIO_US_TRIG_1_PORT, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, GPIO_US_TRIG_1_PIN);
  gpio_mode_setup(GPIO_US_ECHO_1_PORT, GPIO_MODE_INPUT, GPIO_PUPD_NONE, GPIO_US_ECHO_1_PIN);
  gpio_mode_setup(GPIO_US_TRIG_2_PORT, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, GPIO_US_TRIG_2_PIN);
  gpio_mode_setup(GPIO_US_ECHO_2_PORT, GPIO_MODE_INPUT, GPIO_PUPD_NONE, GPIO_US_ECHO_2_PIN);
  gpio_mode_setup(GPIO_US_TRIG_3_PORT, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, GPIO_US_TRIG_3_PIN);
  gpio_mode_setup(GPIO_US_ECHO_3_PORT, GPIO_MODE_INPUT, GPIO_PUPD_NONE, GPIO_US_ECHO_3_PIN);  
}
